...
# ----------------------------- CONFIG (EDIT ME) ------------------------------
GIT_URL="${GIT_URL:-https://github.com/CHANGE_ME/FinalBot.git}"   # <-- your repo URL
ALLOW_IP="${ALLOW_IP:-}"                                          # <-- your home IP (curl ifconfig.me). blank = open to all (NOT recommended)
AUTH_USER="${AUTH_USER:-admin}"                                  # dashboard login name
AUTH_PASS="${AUTH_PASS:-CHANGE_ME}"                              # <-- dashboard password
